...
*/class CornerMButton: MaterialButton {
    ...
    fun initView() { View.inflate(context, R.layout.layout_corner_mbutton, null)/*MaterialButton(context)*/ }
...
//        if(cornerRadius>0){radius = cornerRadius.toFloat()}
        Log.d(TAG, "cornerType="+cornerType
        +"\nRadius="+radius
...
//            } catch(ex:java.lang.Exception) {}
    ...
    override fun getStrokeWidth(): Int {return BigDecimal(strokeWidth.toString()).toInt()}
    ...
    companion object {
        val TAG = CornerMButton.Companion.javaClass.simpleName
    }
}